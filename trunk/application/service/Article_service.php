...
class Article_service extends MY_Service {
	...
	public function insertorupdate($data) {
		...
		if (optionExists($option1)) {
			$data_add['option1'] = $option1;
		}
		if (optionExists($content1)) {
			$data_add['content1'] = $content1;
		}
		if (optionExists($option2)) {
			$data_add['option2'] = $option2;
		}
		if (optionExists($content2)) {
			$data_add['content2'] = $content2;
		}
		if (optionExists($option3)) {
			$data_add['option3'] = $option3;
		}else{
			$data_add['option3'] = "暂无";
		}
		if (optionExists($content3)) {
			$data_add['content3'] = $content3;
		}else{
			$data_add['content3'] = "暂无";
		}
		if (optionExists($option4)) {
			$data_add['option4'] = $option4;
		}else{
			$data_add['option4'] = "暂无";
		}
		if (optionExists($content4)) {
			$data_add['content4'] = $content4;
		}else{
			$data_add['content4'] = "暂无";
		}
